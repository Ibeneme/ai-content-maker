  ...
  return (
    <section className="bg-black py-32 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Pricing Grid - Single Plan centered */}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  {[
                    { icon: <Users size={14} />, label: "3 Person Clusters" }, // Updated to 3 persons
                    {
                      icon: <Mic2 size={14} />,
              ...
              <div className="relative group/img aspect-video lg:aspect-square rounded-3xl overflow-hidden border border-white/5 bg-zinc-900">
                <img
                  src={studioPreview}
                ...
                <div className="absolute inset-0 bg-zinc-950/40 backdrop-blur-[2px] flex items-center justify-center">
                  <div className="text-center p-6 bg-black/60 rounded-2xl border border-white/10 backdrop-blur-md">
                    <Lock className="mx-auto text-[#ec4899] mb-4" size={32} />
                    <span className="text-white font-black uppercase tracking-[0.5em] text-sm block">
                      Deploying Q3
                    </span>
                  </div>
                </div>
